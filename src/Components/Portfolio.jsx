        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-1 md:w-3/3 gap-8 px-12 sm:px-0 ">
          <div class="flex flex-col sm:flex-row max-w-screen-lg ">
            <div class="text-white bg-gradient-to-r from-blue-500 to-cyan-500 md:w-2/3 rounded-md">
              <div class="flex items-center justify-center">
                <button class="w-1/2 px-6 py-2 m-4 duration-50 hover:scale-105 bg-slate-50 text-blue-500 rounded-md text-xl font-extrabold">
                  <a href="https://github.com/VIC-PAUL/Milaap-clone">Code</a>
                </button>
                <button class="w-1/2 px-6 py-2 m-4 duration-50 hover:scale-105  bg-slate-50 text-blue-500 rounded-md text-xl font-extrabold">
          ...
          <div class="flex flex-col sm:flex-row max-w-screen-lg ">
            <div class="text-white bg-gradient-to-r from-blue-500 to-cyan-500 md:w-2/3 rounded-md">
              <div class="flex items-center justify-center">
                <button class="w-1/2 px-6 py-2 m-4 duration-50 hover:scale-105 bg-slate-50 text-blue-500 rounded-md text-xl font-extrabold">
                  <a href="https://github.com/VIC-PAUL/Travelocity-clone">
                    Code
                  </a>
                </button>
                <button class="w-1/2 px-6 py-2 m-4 duration-50 hover:scale-105  bg-slate-50 text-blue-500 rounded-md text-xl font-extrabold">
                  <a href="https://tipify20.netlify.app/">Link</a>
                </button>
              </div>
          ...
          <div class="flex flex-col sm:flex-row max-w-screen-lg ">
            <div class="text-white bg-gradient-to-r from-blue-500 to-cyan-500 md:w-2/3 rounded-md">
              <div class="flex items-center justify-center">
                <button class="w-1/2 px-6 py-2 m-4 duration-50 hover:scale-105 bg-slate-50 text-blue-500 rounded-md text-xl font-extrabold">
                  <a href="https://github.com/VIC-PAUL/sad-kettle-1351">Code</a>
                </button>
                <button class="w-1/2 px-6 py-2 m-4 duration-50 hover:scale-105  bg-slate-50 text-blue-500 rounded-md text-xl font-extrabold">
                  <a href="https://proflow.netlify.app">Link</a>
                </button>
              </div>
